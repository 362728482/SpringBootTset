...
import com.springboot.test.springboottest.entity.Person;
...
public class SpringbootTestApplicationTests {
    ...
    public void mockTest(){
        ...
        testList.add("one");
        testList.add("two");
        when(testList.get(0)).thenReturn("first");
        for (int i=0;i<testList.size();i++){
            System.out.println(testList.get(i));
        }
//        System.out.println(verify(testList).add("one"));
    ...
    public void SerializableTest(){
        ...
        try {
            outputStream=new ObjectOutputStream(new FileOutputStream("E:/person.txt"));
    ...
    @Test
    public void BackSerializableTest(){
        Person person=null;
        ObjectInputStream inputStream=null;
        try {
            inputStream=new ObjectInputStream(new FileInputStream("E:/person.txt"));
            try {
